...
class Metaclass_AddTwoInts_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('service_114514')
        except ImportError:
            import logging
            import traceback
...
class AddTwoInts_Event(metaclass=Metaclass_AddTwoInts_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<service_114514/AddTwoInts_Request, 1>',
        'response': 'sequence<service_114514/AddTwoInts_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['service_114514', 'srv'], 'AddTwoInts_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['service_114514', 'srv'], 'AddTwoInts_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from service_114514.srv import AddTwoInts_Request
    ...
    def response(self, value):
        if self._check_fields:
            from service_114514.srv import AddTwoInts_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_AddTwoInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from service_114514.srv import _add_two_ints
...
class AddTwoInts(metaclass=Metaclass_AddTwoInts):
    from service_114514.srv._add_two_ints import AddTwoInts_Request as Request
    from service_114514.srv._add_two_ints import AddTwoInts_Response as Response
    from service_114514.srv._add_two_ints import AddTwoInts_Event as Event
